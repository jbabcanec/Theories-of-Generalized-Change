...
\noindent \textbf{Note on the Second Edition.} This second edition incorporates extensive corrections to formulas, worked examples, and practice problems throughout all seven chapters and appendices. Pedagogical improvements include additional motivating examples, clearer transitions between topics, expanded key formulas and vocabulary sections, and a restructured treatment of the method of characteristics for partial differential equations.\\ \\
