...
This book is organized into nine chapters, progressively covering essential topics in multivariable calculus and applications:
...
\begin{itemize}
    ...
    \item \textbf{Basic Linear Algebra:} Matrix operations and systems of linear equations is very helpful.
...
\begin{description}
    ...
    \item[$\partial$] Partial derivative symbol. Also used to indicate boundary, ie, $\partial C$
